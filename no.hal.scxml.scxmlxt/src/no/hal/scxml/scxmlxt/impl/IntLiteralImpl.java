 ...
 * <ul>
 *   <li>{@link no.hal.scxml.scxmlxt.impl.IntLiteralImpl#getIntValue <em>Int Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntLiteralImpl extends LiteralImpl implements IntLiteral {
	...
	protected EClass eStaticClass() {
		return ScxmlxtPackage.Literals.INT_LITERAL;
	}
	...
	public void setIntValue(int newIntValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScxmlxtPackage.INT_LITERAL__INT_VALUE, oldIntValue, intValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScxmlxtPackage.INT_LITERAL__INT_VALUE:
				return getIntValue();
		}
