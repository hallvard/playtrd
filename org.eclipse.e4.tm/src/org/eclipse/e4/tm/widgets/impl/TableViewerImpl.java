 ...
 * </copyright>
 *
 * $Id: TableViewerImpl.java,v 1.1 2009/10/23 12:40:32 htraetteb Exp $
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IndexSelection.class) {
			switch (derivedFeatureID) {
				case WidgetsPackage.TABLE_VIEWER__SELECTION_EVENT: return WidgetsPackage.INDEX_SELECTION__SELECTION_EVENT;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexSelection.class) {
			switch (baseFeatureID) {
				case WidgetsPackage.INDEX_SELECTION__SELECTION_EVENT: return WidgetsPackage.TABLE_VIEWER__SELECTION_EVENT;
