 ...
 * <ul>
 *   <li>{@link no.hal.scxml.scxmlxt.impl.BooleanLiteralImpl#isBooleanValue <em>Boolean Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralImpl extends LiteralImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return ScxmlxtPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setBooleanValue(boolean newBooleanValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScxmlxtPackage.BOOLEAN_LITERAL__BOOLEAN_VALUE, oldBooleanValue, booleanValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScxmlxtPackage.BOOLEAN_LITERAL__BOOLEAN_VALUE:
